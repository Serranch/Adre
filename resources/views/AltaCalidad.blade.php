...
<h3 class="m-4">Alta Reporte de Calidad</h3>
<div class="mx-5">
  <form action="AltaProducto" method="post">
    ...
    <div class="form-floating mb-3">
      <input type="text" name="txtDatos" class="form-control" placeholder="Datos" id="floatingInput">
      <label for="floatingInput">Datos</label>
    ...
    <div class="form-floating mb-3">
      <input type="text" name="txtMaquina" class="form-control" placeholder="Maquina" id="floatingInput">
